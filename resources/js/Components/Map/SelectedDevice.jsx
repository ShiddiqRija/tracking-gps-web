    ...
    return (
        <Draggable>
            <div className="flex justify-center">
                <div className="z-20 absolute bottom-4 w-2/12 bg-white drop-shadow-lg px-4 py-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colSpan={2} className="px-2 py-1">
                                    <Button
                                        fullWidthDisabled={route().current("replay.index")}
                                        fullWidth={!route().current("replay.index")}
                                        onClick={() =>

...
export default function Index({ auth }) {
    ...
    const filteredDevices = positionData.filter((device) =>
        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="relative h-screen-bg-gray-100">
                ...
                <div
                    className={
                        isDeviceInfoOpen
                            ? "z-20 absolute bottom-4 left-1/3 transform -translate-x-1/4 w-2/12 bg-white px-4 py-4"
                            : "hidden"
                    }
                >

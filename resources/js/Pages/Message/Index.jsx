        ...
        >
            ...
            <div className="px-4 py-5 sm:px-6 ls:px-8 h-screen bg-gray-100">
                <div className="flex justify-between items-center mb-4">
                    ...
                    <Button primary onClick={createMessage}>+ Create Message</Button>
                </div>
                ...
                <Modal show={isModalOpen} maxWidth="md" onClose={closeModal}>
                    <form onSubmit={handleSubmit} className="p-6">
                        ...
                        <div className="mt-6 flex justify-end">
                            ...
                            <Button primary type="submit" className="ml-3" disabled={processing}>Send</Button>
                        </div>
                    </form>
                </Modal>
                    ...
                    <table className="table-fixed min-w-full border border-gray-300 divide-y divide-gray-200">
                        <thead>
                            <tr>
                                ...
                                <th className="px-4 py-3.5 text-sm font-normal text-left text-gray-500">Message</th>
                                <th className="px-4 py-3.5 text-sm font-normal text-left text-gray-500">Send Time</th>
                                <th className="px-4 py-3.5 text-sm font-normal text-left text-gray-500">Sender</th>
                            </tr>
                        </thead>
                        <tbody>
                            {messages.data.map((message, index) => (
                                <tr key={message.id}>
                                    ...
                                    <td className="px-4 py-2 text-sm text-gray-500 whitespace-nowrap">{message.send_time}</td>
                                    <td className="px-4 py-2 text-sm text-gray-500 whitespace-nowrap">{message.sender}</td>
                                </tr>
                            ))}
                            {messages.data.length === 0 && (
                                <tr>
                                    <td className="px-4 py-2 text-s text-center text-gray-500 whitespace-nowrap" colSpan="6">
                                        No message found.
                                    </td>
                                </tr>
                            )}
